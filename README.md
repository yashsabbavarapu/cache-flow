...
sides of a cache comparison are user questions, so the comparison is symmetric —
not the asymmetric `RETRIEVAL_QUERY`/`RETRIEVAL_DOCUMENT` pair. Measured over 20
